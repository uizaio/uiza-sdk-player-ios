...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UizaSDK_8",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9UizaSDK_815ActionScheduler")
...
SWIFT_CLASS("_TtC9UizaSDK_811FrameLayout")
...
SWIFT_CLASS("_TtC9UizaSDK_817DoubleFrameLayout")
...
SWIFT_CLASS("_TtC9UizaSDK_88NKButton")
...
@interface NKButton (SWIFT_EXTENSION(UizaSDK_8)) <CAAnimationDelegate>
- (void)animationDidStop:(CAAnimation * _Nonnull)anim finished:(BOOL)flag;
@end


SWIFT_CLASS("_TtC9UizaSDK_821NKFloatingViewHandler")
...
SWIFT_CLASS("_TtC9UizaSDK_814NKProgressView")
...
SWIFT_CLASS("_TtC9UizaSDK_813UZModelObject")
...
SWIFT_CLASS("_TtC9UizaSDK_813UZAdsCuePoint")
...
SWIFT_CLASS("_TtC9UizaSDK_815UZAirPlayButton")
...
SWIFT_CLASS("_TtC9UizaSDK_812UZBannerItem")
...
SWIFT_CLASS("_TtC9UizaSDK_812UZCastButton")
...
SWIFT_CLASS("_TtC9UizaSDK_810UZCategory")
...
SWIFT_CLASS("_TtC9UizaSDK_815UZEndscreenView")
...
SWIFT_CLASS("_TtC9UizaSDK_830UZFloatingPlayerViewController")
...
SWIFT_CLASS("_TtC9UizaSDK_810UZHomeData")
@interface UZHomeData : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC9UizaSDK_815UZLiveBadgeView")
...
SWIFT_CLASS("_TtC9UizaSDK_811UZVideoItem")
...
SWIFT_CLASS("_TtC9UizaSDK_811UZLiveEvent")
...
SWIFT_CLASS("_TtC9UizaSDK_818UZLiveStreamUIView")
...
@interface UZLiveStreamUIView (SWIFT_EXTENSION(UizaSDK_8)) <UIGestureRecognizerDelegate>
- (BOOL)gestureRecognizer:(UIGestureRecognizer * _Nonnull)gestureRecognizer shouldReceiveTouch:(UITouch * _Nonnull)touch SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC9UizaSDK_826UZLiveStreamViewController")
...
@interface UZLiveStreamViewController (SWIFT_EXTENSION(UizaSDK_8)) <LFLiveSessionDelegate>
...
SWIFT_CLASS("_TtC9UizaSDK_817UZLiveVideoStatus")
...
SWIFT_CLASS("_TtC9UizaSDK_810UZMenuItem")
...
SWIFT_CLASS("_TtC9UizaSDK_812UZPagination")
...
SWIFT_CLASS("_TtC9UizaSDK_88UZPlayer")
...
@interface UZPlayer (SWIFT_EXTENSION(UizaSDK_8)) <AVPictureInPictureControllerDelegate>
...
SWIFT_CLASS("_TtC9UizaSDK_831UZPlayerContainerViewController")
...
SWIFT_CLASS("_TtC9UizaSDK_819UZPlayerControlView")
...
@interface UZPlayerControlView (SWIFT_EXTENSION(UizaSDK_8)) <UIGestureRecognizerDelegate>
- (BOOL)gestureRecognizer:(UIGestureRecognizer * _Nonnull)gestureRecognizer shouldReceiveTouch:(UITouch * _Nonnull)touch SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC9UizaSDK_817UZPlayerLayerView")
...
SWIFT_CLASS("_TtC9UizaSDK_822UZPlayerViewController")
...
SWIFT_CLASS("_TtC9UizaSDK_88UZSlider")
...
SWIFT_CLASS("_TtC9UizaSDK_813UZThemeConfig")
...
SWIFT_CLASS("_TtC9UizaSDK_86UZUser")
...
@interface UZVideoItem (SWIFT_EXTENSION(UizaSDK_8)) <UIActivityItemSource>
