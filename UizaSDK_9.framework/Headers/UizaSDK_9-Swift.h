...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UizaSDK_9",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9UizaSDK_921NKFloatingViewHandler")
...
SWIFT_CLASS("_TtC9UizaSDK_914NKProgressView")
...
@interface UIColor (SWIFT_EXTENSION(UizaSDK_9))
- (nonnull instancetype)initWithHex:(NSString * _Nonnull)hex;
@end


@interface UIDevice (SWIFT_EXTENSION(UizaSDK_9))
...
SWIFT_CLASS("_TtC9UizaSDK_913UZModelObject")
...
SWIFT_CLASS("_TtC9UizaSDK_913UZAdsCuePoint")
...
SWIFT_CLASS("_TtC9UizaSDK_915UZAirPlayButton")
...
SWIFT_CLASS("_TtC9UizaSDK_912UZBannerItem")
...
SWIFT_CLASS("_TtC9UizaSDK_912UZCastButton")
...
SWIFT_CLASS("_TtC9UizaSDK_916UZCastingManager")
...
@interface UZCastingManager (SWIFT_EXTENSION(UizaSDK_9)) <GCKDiscoveryManagerListener>
- (void)didUpdateDeviceList;
@end

@class GCKMediaStatus;

@interface UZCastingManager (SWIFT_EXTENSION(UizaSDK_9)) <GCKRemoteMediaClientListener>
...
@interface UZCastingManager (SWIFT_EXTENSION(UizaSDK_9)) <GCKRequestDelegate>
...
@interface UZCastingManager (SWIFT_EXTENSION(UizaSDK_9)) <GCKSessionManagerListener>
...
SWIFT_CLASS("_TtC9UizaSDK_910UZCategory")
...
SWIFT_CLASS("_TtC9UizaSDK_915UZEndscreenView")
...
SWIFT_CLASS("_TtC9UizaSDK_930UZFloatingPlayerViewController")
...
SWIFT_CLASS("_TtC9UizaSDK_910UZHomeData")
...
SWIFT_CLASS("_TtC9UizaSDK_915UZLiveBadgeView")
...
SWIFT_CLASS("_TtC9UizaSDK_911UZVideoItem")
...
SWIFT_CLASS("_TtC9UizaSDK_911UZLiveEvent")
...
SWIFT_CLASS("_TtC9UizaSDK_918UZLiveStreamUIView")
...
@interface UZLiveStreamUIView (SWIFT_EXTENSION(UizaSDK_9)) <UIGestureRecognizerDelegate>
...
SWIFT_CLASS("_TtC9UizaSDK_926UZLiveStreamViewController")
...
@interface UZLiveStreamViewController (SWIFT_EXTENSION(UizaSDK_9)) <LFLiveSessionDelegate>
...
SWIFT_CLASS("_TtC9UizaSDK_917UZLiveVideoStatus")
...
SWIFT_CLASS("_TtC9UizaSDK_910UZMenuItem")
...
SWIFT_CLASS("_TtC9UizaSDK_912UZPagination")
...
SWIFT_CLASS("_TtC9UizaSDK_98UZPlayer")
...
@interface UZPlayer (SWIFT_EXTENSION(UizaSDK_9)) <AVPictureInPictureControllerDelegate>
...
@interface UZPlayer (SWIFT_EXTENSION(UizaSDK_9)) <IMAAdsLoaderDelegate, IMAAdsManagerDelegate>
...
SWIFT_CLASS("_TtC9UizaSDK_914UZPlayerConfig")
...
SWIFT_CLASS("_TtC9UizaSDK_931UZPlayerContainerViewController")
...
SWIFT_CLASS("_TtC9UizaSDK_919UZPlayerControlView")
...
@interface UZPlayerControlView (SWIFT_EXTENSION(UizaSDK_9)) <UIGestureRecognizerDelegate>
- (BOOL)gestureRecognizer:(UIGestureRecognizer * _Nonnull)gestureRecognizer shouldReceiveTouch:(UITouch * _Nonnull)touch SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC9UizaSDK_917UZPlayerLayerView")
...
SWIFT_CLASS("_TtC9UizaSDK_922UZPlayerViewController")
...
SWIFT_CLASS("_TtC9UizaSDK_98UZSlider")
...
SWIFT_CLASS("_TtC9UizaSDK_96UZUser")
...
@interface UZVideoItem (SWIFT_EXTENSION(UizaSDK_9)) <UIActivityItemSource>
